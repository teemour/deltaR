...
#' @usage dr_shell(dates, name = "", N = 10000, CI = 0.95,  make.plot = TRUE)
...
#' @references Haslett J, Parnell AC. 2008. A simple monotone process with application to radiocarbondated depth chronologies. Journal of the Royal Statistical Society, Series C. 57: 399-418.  \cr \cr
...
#' Yoneda M, Uno H, Shibata Y, Suzuki R, Kumamoto Y, Yoshida K, Sasaki T, Suzuki A, Kawahata H. 2007. Radiocarbon marine reservoir ages in the western Pacific estimated by pre-bomb molluscan shells. Nuclear Instruments and Methods in Physics Research B 259(1): 432–7.

dr_shell <- function (dates, name = "", N = 10000, CI = 0.95, make.plot = TRUE)
{
